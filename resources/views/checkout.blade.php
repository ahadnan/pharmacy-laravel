                    ...
                    <div class="container guest-checkout">-->
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label ">
                                        <input class="form-check-input" type="Checkbox" name="exampleRadios" id="exampleRadios2" value="option2" data-toggle="collapse" data-target="#collapseExample" aria-controls="collapseExample" >
